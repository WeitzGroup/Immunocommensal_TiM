...
title('High immunity','FontSize',lbsize);
...
%     'HorizontalAlignment','center','VerticalAlignment','middle');
str='B_C wins';
text(lamb_CP_min+0.5*CP_span,lamb_PC_min+0.5*PC_span,str,'Fontsize',flb_size,...
    'HorizontalAlignment','center','VerticalAlignment','middle');
...
ylabel('$\textrm{Competition } B_C \dashv B_P \;(\lambda_{PC})$','fontsize',tlbsize,'Interpreter','latex');
 ...
 saveas(gcf, 'Fig3B1_panel_3', 'fig')
 saveas(gcf,'Fig3B1_panel_3','epsc')
 saveas(gcf, 'Fig3B1_panel_3', 'png')
...
title(c,'\begin{tabular}{c}Pathogen density\\$\langle B_P\rangle \textrm{(g}^{-1}\textrm{)}$\end{tabular}','Interpreter','latex','fontsize',tlbsize);
 ...
 saveas(gcf, 'Fig3B1_p3_pathogen', 'fig')
 saveas(gcf,'Fig3B1_p3_pathogen','epsc')
 saveas(gcf, 'Fig3B1_p3_pathogen', 'png')
...
title(c,'\begin{tabular}{c}Commensal density\\$\langle B_C\rangle \textrm{(g}^{-1}\textrm{)}$\end{tabular}','Interpreter','latex','fontsize',tlbsize);
 ...
 saveas(gcf, 'Fig3B1_p3_commensal', 'fig')
 saveas(gcf,'Fig3B1_p3_commensal','epsc')
 saveas(gcf, 'Fig3B1_p3_commensal', 'png')
