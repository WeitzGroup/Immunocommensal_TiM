...
title('No commensal','FontSize',tlbsize);

%str='Coexistence';
%text(lamb_CP_min+0.25*CP_span,epsKI_min+0.15*epsKI_span,str,'Fontsize',flb_size,...
%    'HorizontalAlignment','center','VerticalAlignment','middle');
 str='B_P wins';
 text(lamb_CP_min+0.5*CP_span,epsKI_min+0.5*epsKI_span,str,'Fontsize',flb_size,...
     'HorizontalAlignment','center','VerticalAlignment','middle');
% str='B_C wins';
% text(lamb_CP_min+0.5*CP_span,epsKI_min+0.5*epsKI_span,str,'Fontsize',flb_size,...
%     'HorizontalAlignment','center','VerticalAlignment','middle');
...
ylabel('$\textrm{Max immune killing } \epsilon K_I \; (\textrm{h}^{-1})$','fontsize',tlbsize,'Interpreter','latex');
 ...
 saveas(gcf, 'Fig3B2_panel_1', 'fig')
 saveas(gcf,'Fig3B2_panel_1','epsc')
 saveas(gcf, 'Fig3B2_panel_1', 'png')
...
title(c,'\begin{tabular}{c}Pathogen density\\$\langle B_P\rangle \textrm{(g}^{-1}\textrm{)}$\end{tabular}','Interpreter','latex','fontsize',tlbsize);
 ...
 saveas(gcf, 'Fig3B2_p1_pathogen', 'fig')
 saveas(gcf,'Fig3B2_p1_pathogen','epsc')
 saveas(gcf, 'Fig3B2_p1_pathogen', 'png')
...
title(c,'\begin{tabular}{c}Commensal density\\$\langle B_C\rangle \textrm{(g}^{-1}\textrm{)}$\end{tabular}','Interpreter','latex','fontsize',tlbsize);
 ...
 saveas(gcf, 'Fig3B2_p1_commensal', 'fig')
 saveas(gcf,'Fig3B2_p1_commensal','epsc')
 saveas(gcf, 'Fig3B2_p1_commensal', 'png')
